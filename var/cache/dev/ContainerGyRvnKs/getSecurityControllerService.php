...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.ddDp.17'] ?? $container->load('get_ServiceLocator_DdDp_17Service'))->withContext('App\\Controller\\SecurityController', $container));
